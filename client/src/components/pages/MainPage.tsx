      ...
      <div>
        ...
        <ul>
          ...
          <li style={{ fontFamily: 'Courier New, Courier, monospace', fontWeight: 'bolder' }}>
            ...
            Правила Этикета и Культурные Особенности: Узнайте о местных обычаях и правилах этикета,
            чтобы чувствовать себя уверенно в любой ситуации. Раздел "Понимание Культуры" поможет
            вам успешно взаимодействовать с местными жителями.
          </li>
          <br />
          <li style={{ fontFamily: 'Courier New, Courier, monospace', fontWeight: 'bolder' }}>
